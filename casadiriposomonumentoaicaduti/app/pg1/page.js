...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      /> 
<br></br><br></br>
      <CenteredText title="CENTRO DIURNO ANCHISE" text="il centro diurno è un servizio territoriale di tipo semi-residenziale rivolto prevalentemente ad anziani con vario grado di non autosufficienza, con prevalente disturbo cognitivo.
